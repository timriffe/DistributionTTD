...
distribution of remaining lifetimes as a function of age itself. All lifetable
...
apply these to human populations. We use HMD data for Swedish females to
illustrate concepts, and provide results for other HMD populations in a
forthcoming online appendix. As an example of utility of this perspective we
suggest a selection of simple heuristics for late life decisions based on these distributional measures.
...
$\gamma_1(y|a)$ is not a perfect measure of symmetry in $f(y|a)$, but it
captures most such variation and can be roughly interpreted in this way. It is calculated as
\begin{equation}
\label{eq:skew}
...
available from the HMD. We begin by outlining the basic age pattern of
...
kurtosis occasionaly suggest different onset dates. 
...
and minus a single standard deviation about $e(a)$. This might be a less useful
...
Data and code used to produce these results will be made available in an open
online repository, and an appendix of results for other HMD populations will
also be made available online.

\section*{Heuristics}
It is our impression that mortality transitions have most
often been described in terms of changes in the hazard.
This is of course attractive because the rates in a given
age can be imagined as independent of other ages.
However, distributional aspects of mortality may play a
decisive role in designing lifespan-related policies and interventions. By
lifespan-related, we refer both to policies that affect and are affected by
lifespan. For instance, \citet{edwards2013cost} derives an approach to
estimating or conceiving of cost to variance in human lifespan. This work was
based on the lifetable deaths distribution as a whole, but we pose the question
that perhaps a) there are costs implicit in other moments and b) these costs may
...
As another example, we imagine that age-specific lifespan distributional
properties may inform judgments on retirement policy. To equalize the duration of retirement between individuals is at
