...
apply these to human populations. As an example of utility of this perspective
we suggest a selection of simple heuristics for late life decisions based on
these distributional measures.
...
linear increasing pattern since the 1950s. Figure~\ref{fig:sdLex} shows the
standard deviation of remaining lifespan, the age pattern of which held roughly
constant for the first 150 years of data, and appears to have started an
abrupt shift starting at the 1918 influenza pandemic and possibly still
underway.
...
\begin{figure}
\centering
\caption{Skewness and Kurtosis of remaining lifespan. Sweden, females in
1751-2011, ages 0-110+.
...
e man Ceteris paribus (i.e., in a homogenous population and
