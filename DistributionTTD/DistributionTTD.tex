...
remaining lifetime to become functions of age. In this paper, we aim to provide
...
We suggest a selection of simple heuristics for late life decisions based on these distributional measures.
...
Recent work has
analyzed variation in the distribution of remaining lifetimes as a
complete function of age \citep{engelman2010implications}, but it is more common
(and sometimes more parsimonious) to analyze the lifetable deaths distribution
after truncating after a fixed age. For instance, \citet{edwards2005inequality}
...
(variation, inequality, and between-population divergence).
...
apply these to human populations from the Human Mortality Database
\citepalias{HMD}.
